...
class Settings(object):
    ...
    def create_default_config(self):
        ...
        log_reg_classif_options = classifiers.LogisticRegressionClassifier.get_default_config()
        sgd_classif_options = classifiers.SGDClassifier.get_default_config()
        pac_classif_options = classifiers.PassiveAggressiveClassifier.get_default_config()
        ridge_classif_options = classifiers.RidgeClassifier.get_default_config()
        gaussian_classif_options = classifiers.GaussianNBClassifier.get_default_config()
        knn_classif_options = classifiers.KNNClassifier.get_default_config()
        radius_classif_options = classifiers.RadiusNeighborsClassifier.get_default_config()
        centroid_classif_options = classifiers.NearestCentroidClassifier.get_default_config()
        tree_classif_options = classifiers.DecisionTreeClassifier.get_default_config()
        random_forest_classif_options = classifiers.RandomForestClassifier.get_default_config()
        extra_trees_classif_options = classifiers.ExtraTreeEnsembleClassifier.get_default_config()
        grad_boost_classif_options = classifiers.GradientBoostingClassifier.get_default_config()
        gaussian_proc_classif_options = classifiers.GaussianProcessClassifier.get_default_config()
        svm_classif_options = classifiers.SVMClassifier.get_default_config()
        linearsvm_classif_options = classifiers.LinearSVMClassifier.get_default_config()
        nu_svm_classif_options = classifiers.NuSVMClassifier.get_default_config()
        linear_disc_classif_options = classifiers.LinearDiscriminantClassifier.get_default_config()
        quadratic_disc_classif_options = classifiers.QuadraticDiscriminantClassifier.get_default_config()
